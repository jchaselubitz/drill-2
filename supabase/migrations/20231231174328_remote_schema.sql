...
CREATE OR REPLACE FUNCTION public.create_subject_lesson_cards(_user_id uuid, _subject_name text, _current_level text, _lesson_title text, _lesson_description text, _cards jsonb)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$DECLARE
    _subject_id int8;
...
BEGIN
    ...
    VALUES (_user_id, _lesson_title, _lesson_description, _subject_id)
