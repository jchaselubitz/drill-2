  ...
  return (
    <div className="animate-in items-center flex flex-col w-full px-2 sm:max-w-md justify-center">
      ...
      <Tabs
        ...
        onValueChange={(value) => {
          router.push(`${pathname}?form=${value}`);
        }}
      >
        ...
        <div className="p-4 rounded-lg mt-2 bg-neutral-100">
          <TabsContent value="magic">
            <LoginForm message={message} token={token} isMagicLink isSignUp={isSignUp} />
          </TabsContent>
          <TabsContent value="password">
            <LoginForm message={message} token={token} isSignUp={isSignUp} />
          </TabsContent>
        </div>
      </Tabs>
    </div>
